...
cd ../Mvc/src/Microsoft.AspNetCore.Mvc.Core
# Core
...
# View Features
cd ../Microsoft.AspNetCore.Mvc.ViewFeatures/
rm -rf bin
rm -rf obj
dotnet restore
dotnet build
...
cp bin/Debug/net451/Microsoft.AspNetCore.Mvc.ViewFeatures.dll "C:\Program Files (x86)\Microsoft Visual Studio 14.0\Common7\IDE\CommonExtensions\Microsoft\Web\Razor\v4.0"
cp bin/Debug/net451/Microsoft.AspNetCore.Mvc.ViewFeatures.dll "C:\Program Files (x86)\Microsoft Visual Studio 14.0\Common7\IDE\Crystal"


# Razor
cd ../Microsoft.AspNetCore.Mvc.Razor/
rm -rf bin
rm -rf obj
dotnet restore
dotnet build
