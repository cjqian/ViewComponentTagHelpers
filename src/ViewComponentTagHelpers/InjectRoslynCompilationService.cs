...
{
    /// <summary>
    /// A type that uses Roslyn to compile C# content, and also injects metadata references into 
    /// compilation references during compilation. Used to reference generated code.
    /// </summary>
    public class InjectRoslynCompilationService : DefaultRoslynCompilationService, ICompilationService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the InjectRoslynCompilationService class.
        /// </summary>
        /// <param name="partManager">The ApplicationPartManager.</param>
        /// <param name="optionsAccessor">Accessor to RazorViewEngineOptions.</param>
        /// <param name="fileProviderAccessor">The IRazorViewEngineFileProviderAccessor.</param>
        ...
        /// <summary>
        /// Concatenates newly-compiled references with references generated by DefaultRoslynCompilationService, and
        /// updates the unique list.
        /// </summary>
        ...
        /// <summary>
        /// Adds the metadataReference to the _compilationReferences list.
        /// </summary>
        ...
        /// <summary>
        /// Compiles compilationContent and appends newly-compiled metadata references to existing metadataferences list.
        /// </summary>
        /// <param name="fileInfo"></param>
        /// <param name="compilationContent"></param>
        /// <returns>CompilationResult of the compiled content.</returns>
        ...
        /// <summary>
        /// Appends compiled references to existing list, and gets the sequence of
        /// MetadataReference instances used for compilation. 
        /// </summary>
        /// <returns>MetadataReference instances.</returns>
